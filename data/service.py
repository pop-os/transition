...
class TransitionException(dbus.DBusException):
    _dbus_error_name = 'org.pop-os.transition.TransitionException'
...
if __name__ == "__main__":
    ...
    bus = dbus.SystemBus()
    name = dbus.service.BusName('org.pop-os.transition', bus)
